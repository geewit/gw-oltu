...
public class JWT {
    ...
    public String toString() {
        return String.format("-- JWT --%nRaw String: %s%nHeader: %s%nClaims Set: %s%nSignature: %s%n---------",
    ...
    public static final class Builder extends CustomizableBuilder<JWT> {
         ...
         */
        private final Map<String, Object> headerCustomFields = new LinkedHashMap<>();
        /**
         * The JWT Header custom fields.
         */
        private final Map<String, Object> claimsSetCustomFields = new LinkedHashMap<>();
        /**
        ...
        public Builder setClaimsSetAudience(String claimsSetAudience) {
            this.claimsSetAudiences = claimsSetAudience == null ? null
                    : Collections.singletonList(claimsSetAudience);
            return this;
        }
        ...
        public Builder setClaimsSetAudiences(List<String> claimsSetAudiences) {
            this.claimsSetAudiences = claimsSetAudiences == null ? null
                    : new ArrayList<>(claimsSetAudiences);
            return this;
        }
